/*
    content-safety-boundary.js (CommonJS / Server-Side Export)
...
class ContentSafetyBoundary {
  /**
   * Evaluates whether a prompt violates the explicit/pornographic boundary.
   *
